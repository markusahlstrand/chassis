...
/**
 * The PeopleCo scenario (spec/concept.md §9): provision → two country scopes →
 ...
 */
describe('PeopleCo (HR) demo scenario (spec §9)', () => {
  let dir: string;
  ...
  it('8. onboarding reuses the protocol engine: the employee fills AND e-signs their own', async () => {
    ...
    // Vertical policy: the EMPLOYEE signs their own onboarding (unlike ServiceCo,
