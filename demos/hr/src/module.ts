...
// ============================================================================
// The PeopleCo vertical (spec/concept.md): employees, leave types, the
...
// (ServiceCo/bikeshop wanting vacation) can force it out cleanly.
//
...
export const peopleCoManifest = moduleManifest.parse({
  id: '@substrat-run/demo-hr',
  version: '0.0.1',
  ...
  entitlementKey: 'peopleco',
});

export const peopleCoMigrations = [
  {
    version: '0001-init',
    sql: `
...
// ---------------------------------------------------------------------------
// Payroll export — the variable-pay handoff (the fakturaunderlag pattern, §7).
...
export const peopleCoModule: ModuleRegistration = {
  manifest: peopleCoManifest,
  migrations: peopleCoMigrations,
  operations: {
