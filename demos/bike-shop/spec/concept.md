# Demo Vertical — "CykelService" (v2 skin)

Status: draft v0.1 · Last updated: 2026-07-14

> The v2 bike-shop skin from [demos/fsm/spec/concept.md](../../fsm/spec/concept.md) §2:
> the *same engines* as ServiceCo (`engine-workorder`, `engine-invoicing`) with
...
| CykelService says | Engine entity | Notes |
|---|---|---|
...
| Fakturaunderlag | `invoicing` underlag | built by the invoicing engine from `workorder.completed`, snapshot not join |
...
## 8. Screens (copy-and-own from ServiceCo's app)
